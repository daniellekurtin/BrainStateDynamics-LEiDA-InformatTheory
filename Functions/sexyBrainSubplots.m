function sexyBrainSubplots (V,CC,kk,Color,lineW)
...
for n=n_pos
    for p = n_pos
        if C(n,p) > 0.001
            ...
            s=surf(X,Y,Z,'FaceColor',[1 C(n,p) 0],'EdgeColor','none','FaceAlpha', .5);
        end
    end
end
...
yline(-10,'color',Color,'LineWidth',lineW)
yline(120,'color',Color,'LineWidth',lineW)

xline(0,'color',Color,'LineWidth',lineW)
xline(120 ,'color',Color,'LineWidth',lineW)
